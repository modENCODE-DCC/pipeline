  ...
  module Status
    ...
    def Status.ok_next_states(project)
      ...
      when EXPAND_FAILED
        ok = [ UPLOADING, DELETING, VALIDATING ]
      when EXPANDED
        ok = [ UPLOADING, DELETING, PREVIEWING, VALIDATING ]
      when VALIDATION_FAILED
        ok = [ UPLOADING, DELETING, PREVIEWING, VALIDATING ]
      when VALIDATED
        ok = [ UPLOADING, DELETING, PREVIEWING, VALIDATING, LOADING ]
      when LOAD_FAILED
        ok = [ UPLOADING, DELETING, PREVIEWING, VALIDATING, LOADING ]
      when LOADED
        ok = [ UPLOADING, DELETING, PREVIEWING, VALIDATING, LOADING, FINDING ]
      when FINDING_FAILED
        ok = [ UPLOADING, DELETING, PREVIEWING, VALIDATING, LOADING, FINDING ]
      when FOUND
