...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = { :session_key => "_pipeline_dev_session_id", :secret => "ModENCODE secret session key for tracking FastCGI sessions between users" }
  # Settings in config/environments/* take precedence over those specified here
 
  # support for user auth mailer
