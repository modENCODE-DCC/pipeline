...
#line 1 "lib/Bio/Graphics/Browser/CAlign.xs"
#include "EXTERN.h"
#include "perl.h"
#include "XSUB.h"
...
#line 196 "lib/Bio/Graphics/Browser/CAlign.c"

XS(XS_Bio__Graphics__Browser__CAlign__do_alignment); /* prototype to pass -Wmissing-prototypes */
XS(XS_Bio__Graphics__Browser__CAlign__do_alignment)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
...
#endif
    if (items < 2 || items > 4)
       Perl_croak(aTHX_ "Usage: %s(%s)", "Bio::Graphics::Browser::CAlign::_do_alignment", "packname=\"Bio::Graphics::Browser::CAlign\", src, tgt, options=NULL");
	...
	SV*	options;
#line 192 "lib/Bio/Graphics/Browser/CAlign.xs"
     MatchMatrix   matrix;
     HV*           optionh;
     SV            **value;
     int           score,i;
     AlignmentPtr  alignment;
     AV*           palign;
#line 223 "lib/Bio/Graphics/Browser/CAlign.c"

	if (items < 1)
	    packname = "Bio::Graphics::Browser::CAlign";
	else {
...
#line 199 "lib/Bio/Graphics/Browser/CAlign.xs"
     {
...
#line 272 "lib/Bio/Graphics/Browser/CAlign.c"
	PUTBACK;
	return;
    }
}
...
extern "C"
#endif
XS(boot_Bio__Graphics__Browser__CAlign); /* prototype to pass -Wmissing-prototypes */
XS(boot_Bio__Graphics__Browser__CAlign)
{
#ifdef dVAR
    dVAR; dXSARGS;
#else
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("Bio::Graphics::Browser::CAlign::_do_alignment", XS_Bio__Graphics__Browser__CAlign__do_alignment, file, "$$;$");
    if (PL_unitcheckav)
